...
<div class="col-md-10 col-md-12 col-sm-12 col-xs-12">
    <h3 class="text-center">Informe Entrevista</h3>  
...
<form role="form" method="POST">
        ...
        <div class="col-md-12">
            <div class="card-box">
                ...
                <div class="row">
                    ...
                    <div>
                        <h5>Agregar las observaciones que sean necesarias.<button id="btnAgregarOE" type="button" class="btn btn-success">Add.</button></h5>
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-condensed table-hover" >
                                <thead>
                                    <th>Observación</th>
    ...
    <div class="row">
        ...
        <a href="{{URL::action('RHEntrevista@PDFEntre',$persona->idempleado)}}"><button type="button" id="btndescargar" class="btn btn-primary">Descargar</button></a>
        <a><button type="button" class="btn btn-primary" 
                  onclick='
                    swal({
                      title: "¿Aceptar?",
                      text: "Está seguro de que aceptar a este usuario",
                      type: "warning",
                      ...
                      function(isConfirm){
                        if (isConfirm) 
                        {
                          swal(
                            {
                              title: "¡Hecho!",
                              text: "El usuario ha sido aceptado!!!",
                              type: "success"
                            },
                            function()
                            {
                                location.href=("{{URL::action("RHEntrevista@nombramiento1",$persona->idempleado)}}");
                ...
                @endif
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">                                   
                    <div class="form-group">
                      ...
                      <input type="text" id="teljefeinmediato" name="teljefeinmediato" maxlength="50" class="form-control" onkeypress="return validaL(event)">
                    </div>
                  </div>
