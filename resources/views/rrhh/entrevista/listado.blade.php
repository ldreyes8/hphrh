                 ...
                 <div class="table-responsive">
                     <table class="table table-striped table-bordered table-condensed table-hover">
                         ...
                         <tr class="even gradeA">
                            ...
                            <td>
                                <a href="{{url('empleado/listadoen/show',array('id'=>$em->identificacion,'ids'=>$var))}}"><button class="btn btn-primary" title="Detalles"><i class="glyphicon glyphicon-zoom-in"></i></button></a>

                                <a href="{{URL::action('RHEntrevista@entrevistarh',$em->idempleado)}}"><button class="btn btn-success" title="Entrevistar"><i class="md md-border-color"></i></button></a>
                                        ...
                                        swal({
                                            ...
                                            if (isConfirm) 
                                            {
                                                swal(
                                                    ...
                                                    function()
                                                    {
                                                        window.location.href="{{url("empleado/rechazoet",array("id"=>$em->idempleado,"ids"=>$em->idstatus))}}";
                                                        //location.reload();
                                                    }
                                                ); 
                                            }
