                 ...
                 <div class="table-responsive">
                     <table class="table table-striped table-bordered table-condensed table-hover" id= "index-reportevpempleado">
                        ...
                        <tr>
                            ...
                            <td>{{$em->statusn}}</td>
                            <td>
                               <button class="btn  btn-default btn-xs" onclick="rh_reporte(1,{{$em->idempleado }})"><i class="fa fa-pencil"></i></button>
                               <button class="btn  btn-default btn-xs" onclick="rh_reporte(2,{{$em->idempleado }})"><i class="fa fa-pencil"></i></button>
                            </td>
                        </tr>
