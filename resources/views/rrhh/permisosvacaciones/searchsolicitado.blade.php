    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="navbar-form navbar-left pull-left">
            <div class="form-group">
                <select  id="select"  class="form-control select2" data-style="btn-info" data-live-search="true" onchange="buscarindexsolicitado();" >
            ...
            <button type="button" class="btn btn-default" onclick="buscarindexsolicitado();">Buscar</button>
        </div>
    </div>
</div>
