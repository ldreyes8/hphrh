...
<form  role="form" id="formUpdate" >
  <div class="row">
            ...
            <p><h2 ALIGN=center>Datos Familiares</h2></p>
              ...
              @foreach($familiares as $fam)
                <tr class="filaTableF">
                  ...
                  <td><input type="text" maxlength="8" class="telefonof" value="{{$fam->telefonof}}"></td>
            ...
            <p><h2 ALIGN=center>Referencia Personales Y Laborales</h2></p>
              ...
              @foreach($referencias as $ref)
                <tr class="filaTableR">
                  ...
                  <td><input type="text" maxlength="8" class="telefonor" value="{{$ref->telefonor}}"></td>
    ...
    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
      ...
      <a href="{{url('empleado/pre_calificadosjf')}}"><button type="button" class="btn btn-primary">Regresar</button></a>
    </div>
</form>
     <div class="col-lg-12">
