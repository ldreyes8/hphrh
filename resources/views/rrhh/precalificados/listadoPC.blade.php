                 ...
                 <div class="table-responsive">
                     <table class="table table-striped table-bordered table-condensed table-hover">
                         ...
                         <tr class="even gradeA">
                            ...
                            <td>
                                <a href="{{url('empleado/pre_calificados/show',array('id'=>$em->identificacion,'ids'=>$var))}}"><button class="btn btn-primary" title="Detalles"><i class="glyphicon glyphicon-zoom-in"></i></button></a>
                                        ...
                                        swal({
                                            ...
                                            if (isConfirm) 
                                            {
                                                swal(
                                                    ...
                                                    function()
                                                    {
                                                        window.location.href="{{url("empleado/rechazopc",array("id"=>$em->idempleado,"ids"=>$em->idstatus))}}";
