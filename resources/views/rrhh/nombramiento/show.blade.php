...
<form  role="form" id="formUpdate" >
  <div class="row">
      ...
      <div class="table-responsive">
        <table id="" class="table table-striped table-bordered table-condensed table-hover table-responsive" >
          <p><h2 ALIGN=center>Licencias de conducir</h2></p>
            ...
            <tbody>
            @if(isset($licencias))
              @foreach($licencias as $par)
                <tr>
                  <td>{{$par->tipolicencia}}</td>
                  <td>{{$par->vigencia}}</td>
                </tr>
              @endforeach
            @endif  
    ...
    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
      ...
      <a href="{{URL::action('Pprueba@update',$empleado->idempleado)}}"><button type="button" class="btn btn-success">Nombramiento</button></a>
      <a> 
            ...
            swal({
                ...
                if (isConfirm) 
                {
                  swal(
                    ...
                    function()
                    {
                      window.location.href="{{url("empleado/rechazon",array("id"=>$empleado->idempleado,"ids"=>$empleado->idstatus))}}";
                      //window.location.href="{{url("empleado/listadon1")}}";
                    }
                  ); 
                }
      ...
      <a href="{{url('empleado/listadon1')}}"><button type="button" class="btn btn-primary">Regresar</button></a>
    </div>
</form>
     <div class="col-lg-12">
