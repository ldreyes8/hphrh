                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td class="body" width="100%" cellpadding="0" cellspacing="0">
                            <table class="inner-body" align="center" width="580" cellpadding="0" cellspacing="0">
                                <!-- Body content -->
                                <tr>
                                    <td class="content-cell">

										<p><strong>El usuario: </strong>{!!$calculo[0]!!}</p>
										<p>Ha realizado una "solicitud de goce vacaciones" y requiere su <br>autorización en el sistema.</p>
