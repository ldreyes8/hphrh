        ...
        <div class="card-box">
            <div class="row"> 
                <div class="col-md-12">
                    ...
                    @if (isset($tablero))<div id="carousel-example-captions1" data-ride="carousel" class="carousel slide">
                    <ol class="carousel-indicators">
                    @for($i =0; $i < count($tablero); $i++)@if($i == 0)<li data-target="#carousel-example-captions1" data-slide-to="0" class="active"></li>
                    @else<li data-target="#carousel-example-captions1" data-slide-to="' . $i . '"></li>
                    @endif
                    @endfor 
                    </ol>
                    <div role="listbox" class="carousel-inner">
                        @for($i =0; $i < count($tablero); $i++)@if($i == 0)<div class="item active">
                        @else<div class="item">
                        @endif<img src="{{asset('tablero/'.$tablero[$i]->imagen)}}" alt="First slide image">
    ...
    <div class="row port">
        <div class="portfolioContainer">
            <div class="col-sm-6  col-md-6 webdesign illustrator">
                @if (isset($cumpledia))<div class="col-md-12">
                        <!--<h4 class=" m-t-0 header-title"><b>H&aacute;bitat guatemala felicita a los cumpleañeros de este d&iacute;a.</b></h4>-->
                        <div class="panel-heading">
                        @foreach($cumpledia as $user)<div class="col-md-4 col-sm-6 col-xs-12">
                            @if ($user->fotoperfil==="")<img  src="{{asset('imagenes/avatar.jpg')}}" class="img-circle" alt="profile-image" width="70px" height ="70px" id="fotografia_usuario">
                            <div class="caption">
                                <h5>{{$user->nombre1.' '. $user->apellido1}}</h5>
                            </div>
                            @else<img  src="{{asset('fotografias/'.$user->fotoperfil)}}" class="img-circle" alt="profile-image" width="70px" height ="70px" id="fotografia_usuario">
                            <div class="caption">
