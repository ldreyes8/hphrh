                ...
                @endif
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" >                                    
                      <div class="form-group">
                          ...
                          <div class="input-group">
                            <input type="text" id="talla" name="talla" maxlength="4" class="form-control" onkeypress="return validaL(event)">
                          </div>
                      </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" >
                      <div class="form-group">
                        ...
                        <input type="text" id="altura" name="altura" maxlength="15" class="form-control">
                      </div>
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" >
                      <div class="form-group">
                        <label for="profesion">Peso</label>
                        <input type="text" id="peso" name="peso" maxlength="15" class="form-control">
                      </div>
                  </div>                    
              	</form>
          </div>
