<div class="tab-pane" id="otros">
  <ul class="nav nav-tabs navtab-custom">
    <li class="active tab"><a href="#generales" data-toggle="tab">Generales</a></li>
    <li><a href="#tabidioma" data-toggle="tab">Agregar Idioma</a></li>
    <li><a href="#tablicencia" data-toggle="tab">Agregar Licencia de conducir</a></li>
