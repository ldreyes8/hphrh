...
<div class="card-box" id="VPJF">
    <h4 class="box-title" align="center">Liquidación de gastos revisados</h4>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <a onclick="detalleviaje(4,{{$v->idempleado}});"><button class="btn btn-info btn-md" id="btnconfirmav" title="Detalles"><i class="glyphicon glyphicon-list-alt"></i></button></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach     
