                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover" id="tabprueba">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$gvi->monto}}</td>
                                @if($gvi->check1 == 1)
                                <td><input id="checkbox1" name="checkbox1" class="checkbox1" type="checkbox" disabled checked value="{{$gvi->idgastoempleado}}"></td>
                                @else
                                <td><input id="checkbox1" name="checkbox1" class="checkbox1" type="checkbox" disabled value="{{$gvi->idgastoempleado}}"></td>
                                @endif
                                @if($gvi->check2 == 1)
