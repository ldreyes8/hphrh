...
CREATE TABLE `caso` (
    `idcaso` INTEGER NOT NULL AUTO_INCREMENT,
    `nombre` VARCHAR(50),
...
# ---------------------------------------------------------------------- #
# Add table "contaregion"                                                #
# ---------------------------------------------------------------------- #

CREATE TABLE `contaregion` (
    `idregionales` INTEGER NOT NULL AUTO_INCREMENT,
    `idafiliado` INTEGER NOT NULL,
    `idempleado` INTEGER NOT NULL,
    `fechaasigna` DATE,
    `motivo` VARCHAR(60),
    CONSTRAINT `PK_contaregion` PRIMARY KEY (`idregionales`)
);
...
CREATE TABLE `nomytras` (
    `idnomytas` INTEGER NOT NULL AUTO_INCREMENT,
    ...
    `idafiliado` INTEGER,
    `idcaso` INTEGER,
    CONSTRAINT `PK_nomytras` PRIMARY KEY (`idnomytas`)
);
...
ALTER TABLE `persona` ADD CONSTRAINT `documento_persona` 
    FOREIGN KEY (`iddocumento`) REFERENCES `documento` (`iddocumento`);

ALTER TABLE `persona` ADD CONSTRAINT `puesto_persona` 
    FOREIGN KEY (`idpuesto`) REFERENCES `puesto` (`idpuesto`);

ALTER TABLE `persona` ADD CONSTRAINT `afiliado_persona` 
...
ALTER TABLE `personaacademico` ADD CONSTRAINT `nivelacademico_personaacademico` 
...
ALTER TABLE `contaregion` ADD CONSTRAINT `afiliado_contaregion` 
    FOREIGN KEY (`idafiliado`) REFERENCES `afiliado` (`idafiliado`);

ALTER TABLE `contaregion` ADD CONSTRAINT `empleado_contaregion` 
    FOREIGN KEY (`idempleado`) REFERENCES `empleado` (`idempleado`);

ALTER TABLE `nomytras` ADD CONSTRAINT `puesto_nomytras` 
    FOREIGN KEY (`idpuesto`) REFERENCES `puesto` (`idpuesto`);

ALTER TABLE `nomytras` ADD CONSTRAINT `empleado_nomytras` 
    FOREIGN KEY (`idempleado`) REFERENCES `empleado` (`idempleado`);

ALTER TABLE `nomytras` ADD CONSTRAINT `afiliado_nomytras` 
    FOREIGN KEY (`idafiliado`) REFERENCES `afiliado` (`idafiliado`);

ALTER TABLE `nomytras` ADD CONSTRAINT `caso_nomytras` 
