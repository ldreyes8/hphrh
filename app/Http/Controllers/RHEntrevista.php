...
class RHEntrevista extends Controller
{
    ...
    public function listadoentrevista (Request $request)
    {
        ...
        $var='5';
        return view('rrhh.entrevista.listado',["empleados"=>$empleados,"searchText"=>$query,"var"=>$var]); 
    }
    ...
    public function listadonombramiento (Request $request)
    {
        ...
        $var='6';
        return view('rrhh.nombramiento.listadon',["empleados"=>$empleados,"searchText"=>$query,"var"=>$var]); 
    }
