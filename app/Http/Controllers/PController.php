      	...
      	if ($request->ajax()){
            ...
            else
            {
              ...
              //  DB::beginTransaction();
                ...
                $idtipoausencia = $request->get('idtipoausencia');
                ...
                if($idtipoausencia === '4')
                {
                  ...
                  if($tdia >= '24')
                  {
                    return response()->json(array('error'=>'No puede solicitar permiso "por enfermedad" usted ha agotado los días autorizados en el año'),200);
                  }
                  else
                  {
                    $day = 1;
                    ...
                    if ($resto - floor($resto) == 0) {
                      ...
                      return response()->json(array('error'=>'No puede solicitar permiso "por enfermedad" usted tiene de saldo '. $resto),200);                      
                    }
                    else
                    {
                ...
                if($concurrencia === 'No')
                {
                  ...
                  if($idtipoausencia === '4' || $idtipoausencia === '7')
                  {
                    $days = 1;
                    while ($ffin >= $fini) {
                      if($fini != $ffin){
